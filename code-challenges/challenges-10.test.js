...
------------------------------------------------------------------------------------------------ */
const count = (target, input) => input.reduce((acc, count) => acc + count.reduce((acc, count) => acc + (count === target), 0), 0);
...
const totalSum = (input) => input.reduce((acc, count) => acc + count.reduce((acc, count) => acc + count, 0), 0);
...
let findShortest = (data) => data.reduce((acc, count) => (parseInt(acc.height) < parseInt(count.height)) ? acc : count).name;
