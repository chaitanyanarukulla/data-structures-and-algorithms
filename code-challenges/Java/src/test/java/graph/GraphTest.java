...
public class GraphTest {
    @Test
    public void test_graph_IsEmpty(){
        Graph graph = new Graph();
        assertEquals(0, graph.getNodeNum());
    }

    @Test
    public void test_addANode() {
    ...
    @Test
    public void test_neighborsAndWeights(){
        Graph testing = new Graph();
        Node one = testing.addNode("one");
        Node two = testing.addNode("two");
    ...
    @Test
    public void test_testingBreadthTraversal() {
        Graph testing = new Graph();
        Node one = testing.addNode("one");
        Node two = testing.addNode("two");
        Node three = testing.addNode("three");
    ...
    @Test
    public void test_testingDepthTraversal() {
        Graph testing = new Graph();
        Node one = testing.addNode("one");
        Node two = testing.addNode("two");
        Node three = testing.addNode("three");
